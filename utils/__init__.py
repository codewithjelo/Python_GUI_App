...
class WelcomeScreen():
    ...
    def welcome_screen(self):
        ...
        # Welcome Screen
        welcome_label = customtkinter.CTkLabel(master=self.frame, text="Welcome to PCFIND", font=('Montserrat', 14, 'bold'),
                                               text_color='#2FA572')
