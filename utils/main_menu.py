...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        # def remove():
        #
        #         item_to_remove = self.display_label.cget('text') + '\t\tPHP' + str(prices[self.display_label.cget('text')])
        #         transaction_list = self.order_transaction_label.cget('text').split('. ')
        ...
        #                                                    font=('Montserrat', 14, 'bold'), command=remove)
